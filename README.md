...
It saves the contents of the clipboard in file "testscript.py" and executes it. It ONLY executes content which is different from previously copied contents.
